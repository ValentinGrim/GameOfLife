...
int majPosition(Balle *Balle_v, AttracteurList *pAttrList,
                float dt) // Mise à jour de la position de la balle en appliquant le PFD et retourne -1 si balle est NULL (sécurité)
{
